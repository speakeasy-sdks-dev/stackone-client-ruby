...
module StackOne
  module Shared
    ...
    class ApplicationsPaginated < StackOne::Utils::FieldAugmented
      extend T::Sig


      field :data, T::Array[Shared::Application], { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[Shared::Application], next_: T.nilable(String), next_page: T.nilable(String), raw: T.nilable(T::Array[Shared::RawResponse])).void }
