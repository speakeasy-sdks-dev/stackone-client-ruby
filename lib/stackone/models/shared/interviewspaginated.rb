...
module StackOne
  module Shared
    ...
    class InterviewsPaginated < StackOne::Utils::FieldAugmented
      ...
      field :data, T::Array[Shared::Interview], { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[Shared::Interview], next_: T.nilable(String), next_page: T.nilable(String), raw: T.nilable(T::Array[Shared::RawResponse])).void }
