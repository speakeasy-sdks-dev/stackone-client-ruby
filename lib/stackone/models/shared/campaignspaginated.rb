...
module StackOne
  module Shared
    ...
    class CampaignsPaginated < StackOne::Utils::FieldAugmented
      ...
      field :data, T::Array[Shared::Campaign], { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('data') } }
      ...
      sig { params(data: T::Array[Shared::Campaign], next_: T.nilable(String), next_page: T.nilable(String), raw: T.nilable(T::Array[Shared::RawResponse])).void }
