...
require 'faraday'
require_relative '../shared/atscreatecandidaterequestdto'
...
module StackOne
  module Operations
    ...
    class AtsCreateCandidateRequest < StackOne::Utils::FieldAugmented
      ...
      field :ats_create_candidate_request_dto, Shared::AtsCreateCandidateRequestDto, { 'request': { 'media_type': 'application/json' } }
      # The account identifier
      field :x_account_id, String, { 'header': { 'field_name': 'x-account-id', 'style': 'simple', 'explode': false } }


      sig { params(ats_create_candidate_request_dto: Shared::AtsCreateCandidateRequestDto, x_account_id: String).void }
