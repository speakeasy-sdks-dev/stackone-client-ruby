...
module StackOne
  ...
  class Proxy
    ...
    sig { params(proxy_request_body: Shared::ProxyRequestBody, x_account_id: String).returns(Utils::FieldAugmented) }
    def proxy_request(proxy_request_body, x_account_id)
      # proxy_request - Proxy Request
      request = Operations::StackoneProxyRequestRequest.new(
      ...
      res = Operations::StackoneProxyRequestResponse.new(
