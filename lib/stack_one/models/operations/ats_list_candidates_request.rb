...
module StackOne
  module Operations
    ...
    class AtsListCandidatesRequest < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(x_account_id: ::String, fields_: T.nilable(::String), next_: T.nilable(::String), page: T.nilable(::String), page_size: T.nilable(::String), proxy: T.nilable(::StackOne::Operations::AtsListCandidatesQueryParamProxy), raw: T.nilable(T::Boolean), sync_token: T.nilable(::String), updated_after: T.nilable(::String)).void }
