...
module StackOne
  module Operations
    ...
    class HrisListLocationsResponse < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, hris_locations_paginated: T.nilable(::StackOne::Shared::HRISLocationsPaginated)).void }
