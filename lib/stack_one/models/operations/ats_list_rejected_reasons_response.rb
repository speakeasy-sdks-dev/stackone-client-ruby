...
module StackOne
  module Operations
    ...
    class AtsListRejectedReasonsResponse < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, rejected_reasons_paginated: T.nilable(::StackOne::Shared::RejectedReasonsPaginated)).void }
