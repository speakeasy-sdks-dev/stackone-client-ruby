...
module StackOne
  module Operations
    ...
    class AtsListDepartmentsResponse < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, departments_paginated: T.nilable(::StackOne::Shared::DepartmentsPaginated)).void }
