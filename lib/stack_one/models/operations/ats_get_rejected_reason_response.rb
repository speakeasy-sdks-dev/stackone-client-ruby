...
module StackOne
  module Operations
    ...
    class AtsGetRejectedReasonResponse < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, rejected_reason_result: T.nilable(::StackOne::Shared::RejectedReasonResult)).void }
