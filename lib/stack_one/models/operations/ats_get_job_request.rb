...
module StackOne
  module Operations
    ...
    class AtsGetJobRequest < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(id: ::String, x_account_id: ::String, expand: T.nilable(::String), fields_: T.nilable(::String), next_: T.nilable(::String), page: T.nilable(::String), page_size: T.nilable(::String), proxy: T.nilable(::StackOne::Operations::AtsGetJobQueryParamProxy), raw: T.nilable(T::Boolean), sync_token: T.nilable(::String), updated_after: T.nilable(::String)).void }
