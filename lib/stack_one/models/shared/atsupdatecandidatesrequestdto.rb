...
module StackOne
  module Shared
    ...
    class AtsUpdateCandidatesRequestDto < ::StackOne::Utils::FieldAugmented
      ...
      sig { params(application_ids: T.nilable(T::Array[::String]), company: T.nilable(::String), emails: T.nilable(T::Array[::StackOne::Shared::CandidateEmail]), first_name: T.nilable(::String), id: T.nilable(::String), last_name: T.nilable(::String), name: T.nilable(::String), phone: T.nilable(::String), title: T.nilable(::String)).void }
